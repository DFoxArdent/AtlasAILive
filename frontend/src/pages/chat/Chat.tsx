...
const Chat = () => {
    ...
    const makeApiRequestWithoutCosmosDB = async (question: ChatMessage["content"], conversationId?: string) => {
        ...
        const finalQuestion = typeof question !== 'string' && question[0]?.text?.length > 0
            ? question[0].text
            : question;
                                  ...
                                  <CommandBarButton
                                    ...
                                    styles={{
                                      ...
                                      root: {
                                        color: '#FFFFFF',
                                        background:
                                          'linear-gradient(135deg, #0f6cbd 0%, #2d87c3 51.04%, #8dddd8 100%)',
                                      },
                                      rootHovered: {
                                        background:
